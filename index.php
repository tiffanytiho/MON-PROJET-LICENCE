...
<body>
    ...
    <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="social-wallpaper">
                                        <img src="images/btp1.jpg" alt=" Image de fond">  
                                    </div>
                                    <div class="timeline-btn">
                                        <a href="connexion.php" class="btn btn-success waves-effect waves-light">
                                            Faire un post
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-9 col-lg-8 col-md-8 col-xs-12 ">
                                    <div class="card social-tabs">
                                        <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#timeline" role="tab">Ecole</a>
                                                <div class="slide">
                                                </div>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#about" role="tab">Hopital</a>
                                                <div class="slide"> </div>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#photos" role="tab">Route</a>
                                                <div class="slide"></div>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#friends" role="tab">Autre</a>
                                                <div class="slide"></div>
                                            </li>
                                        </ul>
                                    </div>
                                                                    ...
                                                                    <img src="https://www.bootdey.com/image/800x350/87CEFA/000000" class="img-fluid width-100" alt>
                                                                            ...
                                                                            <div class="card-block b-b-theme b-t-theme social-msg">
                                                                                <a href="#"> 
                                                                                    ...
                                                                                    <span class="b-r-muted">Like (20)</span> 
                                                                                </a>
                                                                                <a href="#"> 
                                                                                    <i class="icofont icofont-comment text-muted"></i> 
                                                                                    <span class="b-r-muted">Comments (25)</span>
                                                                                </a>
                                                                                <a href="#"> 
        ...
        <session> </session>
        <div class="container" id="a-propos"> </div>
</body>
</html>