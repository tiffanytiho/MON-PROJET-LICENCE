                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="timeline-btn">
                                        <a href="prifile.php" class="btn btn-primary waves-effect waves-light m-r-10">
                                            Editer mon profile
                                        </a>
                                        <a href="forum.php" class="btn btn-primary waves-effect waves-light">
                                            Faire un post
                                        </a>
                                        <a href="index.php" class="btn btn-primary waves-effect waves-light m-r-10">
                                            Acceuil
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="social-timeline-left">
                                            ...
                                            <div class="card-block social-follower">
                                                ...
                                                <div class>
                                                    <button type="button" class="btn btn-outline-primary waves-effect btn-block">
                                                        <i class="icofont icofont-ui-user m-r-10"></i> Ajouter des amis
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="card-header-text">Qui me suit</h5>
                                            </div>
                                            <div class="card-block user-box">
                                                <div class="media m-b-10">
                                                    <a class="media-left" href="#!">
                                                        ...
                                                        <div class="live-status bg-danger"> 
                                                        </div>
                                                    </a>
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="card-header-text d-inline-block">Amis</h5>
                                                        <span class="label label-primary f-right"> Plus de 12 </span>
                                                    </div>
                                        ...
                                        <div class="col-xl-9 col-lg-8 col-md-8 col-xs-12 ">
                                            <div class="card social-tabs">
                                                <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" data-toggle="tab" href="#timeline" role="tab">Home</a>
                                                        <div class="slide">
                                                        </div>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#about" role="tab">A propos</a>
                                                        <div class="slide">
                                                        </div>
                                                    </li>
                                                    <li class="nav-item">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#friends" role="tab">Amis</a>
                                                        <div class="slide"></div>
                                                    </li>
                                                </ul>
                                            </div>
                                                                    ...
                                                                    <div class="col-10 col-sm-10 col-xl-11 p-l-5 p-b-35">
                                                                        <div class="card">
                                                                            ...
                                                                            <div class="card-block b-b-theme b-t-theme social-msg">
                                                                                ...
                                                                                <a href="#"> <i class="icofont icofont-comment text-muted"></i> <span class="b-r-muted">Commentaires (25)</span></a>
                                                                                <a href="#"> <i class="icofont icofont-share text-muted"></i> <span>Partage (10)</span></a>
                                                                            </div>
                                                                            <div class="card-block user-box">
                                                                                <div class="p-b-30"> 
                                                                                    <span class="f-14">
                                                                                ...
                                                                                <div class="media">
                                                                                    ...
                                                                                    <div class="media-body">
                                                                                        <form class>
                                                                                            <div class>
                                                                                                <textarea rows="5" cols="5" class="form-control" placeholder="Write Something here...">
                                                                                                </textarea>
                                                                            ...
                                                                            <div class="col-lg-6 col-md-12">
                                                                                <form>
                                                                                    <table class="table table-responsive m-b-0">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <th class="social-label b-none p-t-0">Full Name </th>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="social-user-name b-none text-muted">
                                                                                                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a0d4c5d3d4e0c7cdc1c9cc8ec3cfcd">
                                                                                                    [email&#160;protected]
                                                                                                </a>
                                                                                            </td>
                                                                                        </tr>
